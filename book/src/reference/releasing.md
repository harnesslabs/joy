...
Windows MSVC support exists for local/CI builds, but the release artifact currently remains GNU-targeted.
...
4. Validate distribution metadata (`just dist-metadata-check`).
